...
Testing is read-only and reports reachability, authentication, compatibility,
latency, capabilities, library count, queue, calendar, and health. Save remains
disabled until validation succeeds. Credentials are encrypted with AES-256-GCM
