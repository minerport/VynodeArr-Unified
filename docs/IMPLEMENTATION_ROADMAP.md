...
- **N2 complete:** GET-only adapters, normalized gateway, basic auth, Docker
  and Unraid review packaging.
- **N3 complete:** guided first run, durable accounts/sessions/projections,
