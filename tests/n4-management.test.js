...
test('native interaction workflows replace an upstream-shaped generic shell',async()=>{
  ...
  for(const control of ['Release, source, quality…','All statuses','All sources','All qualities','Showing {visible.length} of {items.length} releases','release-sort-direction'])assert.ok(releaseBrowser.includes(control),control);
