...
public sealed class EngineSupervisorTests
{
    ...
    public async Task LaunchesEnginesWithSeparateLoopbackConfiguration()
    {
        ...
        try
        {
            ...
            Assert.Equal("127.0.0.1", movie.EnvironmentVariables["VynodeMovies__Server__BindAddress"]);
            Assert.Equal("/movies", movie.EnvironmentVariables["VynodeMovies__Server__UrlBase"]);
            ...
            Assert.Equal("127.0.0.1", television.EnvironmentVariables["VynodeTV__Server__BindAddress"]);
            Assert.Equal("/television", television.EnvironmentVariables["VynodeTV__Server__UrlBase"]);
