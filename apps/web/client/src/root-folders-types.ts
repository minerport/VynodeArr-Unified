...
export interface AvailableLibraryFolder{path:string;label:string;domain:StorageDomain|null;configured:boolean;registered?:boolean;registeredMovie?:boolean;registeredTv?:boolean;registeredMusic?:boolean}
...
export interface RootFoldersMountOptions{
  initialDomain?:StorageDomain|'music';
