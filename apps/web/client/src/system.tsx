...
import type { ApplicationUpdate,AuditEntry,DiskSpace,MasterKeyStatus,SystemDomain,SystemMountOptions,SystemRecord,SystemView } from './system-types';
