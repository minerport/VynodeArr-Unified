...
import type { ReeltrackListsMountOptions } from './reeltrack-lists-types';
...
let mediaExpansionRoot:Root|null=null;
...
function unmountOperations(){operationsRoot?.unmount();operationsRoot=null;}
function mountOperations(element:HTMLElement,options:OperationsMountOptions){unmountOperations();const root=createRoot(element);operationsRoot=root;root.render(loading('operations'));void import('./operations-center').then(({OperationsCenterView})=>{if(operationsRoot===root)root.render(guarded(<OperationsCenterView options={options}/>));});}
...
function unmountReeltrackLists(){reeltrackListsRoot?.unmount();reeltrackListsRoot=null;}
function mountReeltrackLists(element:HTMLElement,options:ReeltrackListsMountOptions){
  unmountReeltrackLists();const root=createRoot(element);reeltrackListsRoot=root;root.render(loading('Reeltrack lists'));
  void import('./reeltrack-lists').then(({ReeltrackListsView})=>{if(reeltrackListsRoot===root)root.render(guarded(<ReeltrackListsView options={options}/>));});
}
...
function unmountLibraryReview(){libraryReviewRoot?.unmount();libraryReviewRoot=null;}
function mountLibraryReview(element:HTMLElement,options:LibraryReviewMountOptions){
  unmountLibraryReview();const root=createRoot(element);libraryReviewRoot=root;root.render(loading('library review'));
  void import('./library-review').then(({LibraryReviewView})=>{if(libraryReviewRoot===root)root.render(guarded(<LibraryReviewView options={options}/>));});
}
function unmountPosterOverlays(){posterOverlaysRoot?.unmount();posterOverlaysRoot=null;}
function mountPosterOverlays(element:HTMLElement,options:PosterOverlayMountOptions){
  unmountPosterOverlays();const root=createRoot(element);posterOverlaysRoot=root;root.render(loading('poster overlays'));
  void import('./poster-overlays').then(({PosterOverlaysView})=>{if(posterOverlaysRoot===root)root.render(guarded(<PosterOverlaysView options={options}/>));});
}
function unmountMediaExpansion(){mediaExpansionRoot?.unmount();mediaExpansionRoot=null;}
function mountMediaExpansion(element:HTMLElement,options:MediaExpansionOptions){
  unmountMediaExpansion();const root=createRoot(element);mediaExpansionRoot=root;root.render(loading(options.initialSection));
  void import('./media-expansion').then(({MediaExpansionView})=>{if(mediaExpansionRoot===root)root.render(guarded(<MediaExpansionView options={options}/>));});
}
...
const routeImports:Record<string,()=>Promise<unknown>>={
  dashboard:()=>import('./dashboard'),music:()=>import('./media-expansion'),subtitles:()=>import('./media-expansion'),discover:()=>import('./discover'),requests:()=>import('./my-requests'),'request-management':()=>import('./request-management'),operations:()=>import('./operations-center'),collections:()=>import('./collections'),lists:()=>import('./reeltrack-lists'),add:()=>import('./add-media'),movies:()=>import('./library'),tv:()=>import('./library'),
...
declare global {
  interface Window {VynodeArrReact?:{
    ...
    mountOperations:(element:HTMLElement,options:OperationsMountOptions)=>void;unmountOperations:()=>void;
    ...
    mountLibraryReview:(element:HTMLElement,options:LibraryReviewMountOptions)=>void;unmountLibraryReview:()=>void;
    mountPosterOverlays:(element:HTMLElement,options:PosterOverlayMountOptions)=>void;unmountPosterOverlays:()=>void;
    mountMediaExpansion?:(element:HTMLElement,options:MediaExpansionOptions)=>void;unmountMediaExpansion?:()=>void;
    ...
    mountNotifications:(element:HTMLElement,options:NotificationMountOptions)=>void;
...
Object.assign(window.VynodeArrReact!,{mountMediaExpansion,unmountMediaExpansion});
