export type ServiceSection='root-folders'|'media-management'|'profiles'|'custom-formats'|'guide-templates'|'release-profiles'|'indexers'|'download-clients'|'discover'|'advanced';
