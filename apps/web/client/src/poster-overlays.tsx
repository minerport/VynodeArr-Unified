...
const responsiveLayoutStyles = `.poster-overlay-route{min-width:0}.poster-overlay-route .hero h1{font-size:clamp(2rem,5vw,4rem);overflow-wrap:anywhere}.poster-overlay-route>.settings-tabs{display:flex;flex-wrap:nowrap;gap:8px;overflow-x:auto;padding:8px}.poster-overlay-route>.settings-tabs a{flex:0 0 auto;min-width:max-content;padding:10px 14px}.overlay-template-card{grid-template-columns:76px minmax(0,1fr);min-width:0}.overlay-template-card>.overlay-preview{width:76px}.overlay-template-content{min-width:0}.overlay-template-content .form-actions{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:6px}.overlay-template-content button{width:100%;min-width:0}@media(max-width:800px){.poster-overlay-route{gap:14px}.poster-overlay-route>.panel{padding:14px}.overlay-studio-grid{grid-template-columns:1fr}.overlay-template-list{gap:10px}}@media(max-width:600px){.poster-overlay-route .hero>.primary{width:100%;min-height:48px}.poster-overlay-route>.settings-tabs a{padding:9px 12px}.overlay-template-panel .panel-heading .badge{align-self:flex-start}.overlay-template-card{grid-template-columns:64px minmax(0,1fr);align-items:center;gap:10px;padding:10px}.overlay-template-card>.overlay-preview{width:64px}.overlay-template-content{display:grid;gap:5px}.overlay-template-content .form-actions{grid-template-columns:repeat(3,minmax(0,1fr));position:static;margin:3px 0 0;padding:0;border:0;background:none;backdrop-filter:none}.overlay-template-content button{min-height:44px;padding:6px 3px;font-size:.78rem}}`;
