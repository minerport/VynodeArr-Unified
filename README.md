...
standard Docker installations. Version **2.0.35-rc.28** is available as a
prerelease with complete scrolling overlay libraries, whitespace-preserving
layer prefixes and suffixes, compact Plex match controls, and stable overlay
styling that is loaded once instead of reinjected for every preview. The production release includes a durable local Movie and Television catalog, targeted
