...
The supported Linux x64 package is published in [VynodeArr 0.4.6](https://github.com/minerport/VynodeArr-Unified/releases/tag/v0.4.6). Download the archive and checksum, verify them, extract the package, and run `sudo ./install.sh`. Detailed commands, service management, permissions, upgrades, and uninstall instructions are in [`distribution/linux/README.md`](distribution/linux/README.md).
