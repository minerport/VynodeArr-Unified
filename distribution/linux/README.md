...
```bash
wget https://github.com/minerport/VynodeArr-Unified/releases/download/v0.4.2/VynodeArr-0.4.2-linux-x64.tar.gz
wget https://github.com/minerport/VynodeArr-Unified/releases/download/v0.4.2/VynodeArr-0.4.2-linux-x64.tar.gz.sha256
sha256sum --check VynodeArr-0.4.2-linux-x64.tar.gz.sha256
tar -xzf VynodeArr-0.4.2-linux-x64.tar.gz
